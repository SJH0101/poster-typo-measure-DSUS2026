...
.venv/bin/python docs/labeling/select.py ~/.typo-mcp/brockmann.json docs/labeling/caps_claude_eye.json docs/labeling/rotation.json "~/Documents/연구2/브로크만 정리/corpus/코어" docs/labeling --boxed_csv ~/Downloads/boxes_라벨러A-2.csv
